            ...
            <div id="container">
                <div id="filtros" >
                    <form >
                        ...
                        <div id="filtrosInt">
                            <button id="alterCenter" className="btn btn-primary" type="button" className="form-control" className="form-control">FILTRAR</button>
                        </div>
                    </form>
                </div>
                ...
                <div id="perfilCuid">
                    <div className="card" id="cardCuidadores">
                        <div className="cardTop" id="idTituloCuidador">
