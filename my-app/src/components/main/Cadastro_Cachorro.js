...
function Cadastro_Cachorro(props) {
    ...
    return (
        <div id="idDivImagemCachorro">
            <div id="idCachorro">
                <form id="idFormCuidadorCachorro">
                    <h1 id="idTituloCachorro">Cadastro Cuidador: Cachorro</h1>
                    <br /><br />
                    <div id="idCheckboxCachorro">
                        <input type="checkbox" id="idHabilit" onClick={habilitar} />
                        <label id="idDisable" htmlFor="idHabilit"> Quero ser um cuidador</label>
                    </div>
                    <br /><br />
                    <div id="idFormCachorro">
                        <div id="idValSerCachorro">
                            <label htmlFor="idValorServico">Valor do serviço: </label>
                            <input type="number" id="idValorServico" name="nmValorServico" className="form-control" disabled="disabled" step="0.1"/>
                        </div>
                        <div id="idLocCuiCachorro">
                            <label htmlFor="idLocalCuidado">Local de trabalho: </label>
                    ...
                    <br />
                    <h4 id="idTitPerioCachorro"><b>Selecione os dias e o período que você deseja trabalhar</b></h4>
