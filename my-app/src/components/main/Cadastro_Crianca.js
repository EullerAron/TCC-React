...
function Cadastro_Crianca(props) {
    ...
    return (
        <div id="idDivImagemCrianca">            
            <div id="idCrianca">
                <form id="idFormCuidadorCrianca">
                    <h1 id="idTituloCrianca">Cadastro Cuidador: Criança</h1>
                    <br /><br />
                    <div id="idCheckboxCrianca">
                        <input type="checkbox" id="idHabilit" onClick={habilitar} />
                        <label id="idDisable" htmlFor="idHabilit">Quero ser um cuidador</label>
                    </div>
                    <br /><br />
                    <div id="idFormCrianca">
                        <div id="idValSer">
                        ...
                        <div id="idGenCrianca">
                            <label htmlFor="idGenero">Sexo: </label>
                    ...
                    <br />
                    <h4 id="idTitPerioCrianca"><b>Selecione os dias e o período que você deseja trabalhar</b></h4>
